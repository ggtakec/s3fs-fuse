...
static const char help_string[] = 
    ...
    "\n"
    "   strict_dir_empty (strictly checking directory empty)\n"
    "        This option is strictly checking a directory is empty.\n"
    "        With this option, check not only the number of objects in the list\n"
    "        bucket, but also the existence of the objects.\n"
    "        This can filter out objects that are listed but do not exist.\n"
    "        Specifying this option with the compat_dir option is not recommended.\n"
    "        This option is mainly used to support MinIO versioning buckets.\n"
    "\n"

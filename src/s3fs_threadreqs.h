...
//
// Pre Multipart Post Request parameter structure for Thread Pool.
//
struct pre_multipart_post_req_thparam
{
    std::string path;
    headers_t   meta;
...
//
// Complete Multipart Post Request parameter structure for Thread Pool.
//
struct complete_multipart_post_req_thparam
{
    std::string path;
    std::string upload_id;
    etaglist_t  etaglist;

...
class S3fsCurl
{
    ...
    private:
        ...
        std::vector<std::thread::id> *completed_tids;   // ([TODO] If S3fsMultiCurl is discontinued, this variable will be deleted.)
    ...
    private:
        ...
        int CopyMultipartSetup(const char* from, const char* to, int part_num, const std::string& upload_id, const headers_t& meta);

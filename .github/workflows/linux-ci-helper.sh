...
if [ "${CONTAINER_FULLNAME}" = "ubuntu:25.04" ]; then
    ...
    INSTALL_PACKAGES="bash clang-extra-tools curl g++ make automake autoconf libtool git curl-dev fuse3-dev jq libxml2-dev openssl coreutils procps attr sed mailcap openjdk21 perl-test-harness-utils aws-cli"
